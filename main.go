...
// func main() {
// 	file, _ := ioutil.ReadFile("/home/justen/org/story/mora.org")
// 	var str []string

// 	str = strings.Split(string(file), "\n")

// 	str = disspress.RemoveIfContains(str, "#")
// 	str = disspress.RemoveIfContains(str, ".png")

// 	str = disspress.RemoveTag(str, "noexport")
// 	str = disspress.RemoveTag(str, "misc")

// 	string := strings.Join(str, "\n")
// 	str = strings.Split(string, " ")

// 	disspress.WriteDissociatively(str, 0)
// }

func main() {
	str := `Edward Snowden’s Long,
Strange Journey to Hollywood
Oliver Stone wanted a hit — and the chance to put America’s most iconic
dissident onscreen. The subject wanted veto power. The Russian lawyer
wanted someone to option the novel he’d written. The American lawyer just
wanted the whole insane project to go away. Somehow a film got made.
...
Kucherena entered the picture as Snowden’s lifeline, or at least as someone who could help him navigate Russia’s asylum laws. An experienced lawyer, Kucherena was appointed by Putin to the Public Council, overseeing the Federal Security Service (F.S.B.). Snowden’s case presented a new opportunity. It took Kucherena a month to negotiate Snowden’s stay and three months to write “Time of the Octopus."`
	...
	disspress.getWordCount(string, "the")
	disspress.WriteDissociatively(string, 0)
}
